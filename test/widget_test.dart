...
//  print(myCurve.transform(0.5));
  ...
  test("Testing Custom curve 2 - should pass", (){
    expect(testCurve.transform(0.2), 0.0);
  });
  ...
  test("Testing Custom curve 3 - should pass", (){
    expect(testCurve.transform(1.0), 0.0);
  });
  ...
  test("Testing Custom curve 4 - should fail", (){
    expect(testCurve.transform(0.5), Curves.decelerate.transform(0.5));
  });

  test("Testing Custom curve 4 - should fail", (){
    expect(testCurve.transform(0.55), Curves.decelerate.transform(0.25));
  });
